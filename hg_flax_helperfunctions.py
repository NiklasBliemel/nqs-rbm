...
def hf_download_flax_parameter(repo_id: str, branch_name: str = "main") -> dict:
    path = hf_hub_download(repo_id=repo_id, revision=branch_name, filename="parameter.msgpack")
